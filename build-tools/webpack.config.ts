...
export default function(env: any, argv: any) {
  ...
  let config1: webpack.Configuration = {
    ...
    output: {
      path: path.resolve(projectRootPath, "./dist1"),
      filename: "[name].js"
      ...
      rules: [
          ...
          use: [
            {
              loader: "cache-loader",
              options: {
                cacheDirectory: path.resolve(projectRootPath, "./build-temp", "ts")
              }
            },
            { loader: "babel-loader", options: babelConfig },
            {
              loader: path.resolve(projectRootPath, "./build-tools/loaders/print-loader.js"),
              options: {
        ...
        },
        {
          ...
          use: [
            ...
            {
              loader: path.resolve(projectRootPath, "./build-tools/loaders/lessToCss-loader.js")
            },
            {
              loader: "less-loader",
              options: {}
        ...
        {
          test: /\.txtt$/,
          loader: path.resolve(projectRootPath, "./build-tools/loaders/txt-loader.js")
        }
      ]
    },
    optimization: {
    ...
    plugins: [
      new CleanWebpackPlugin(["dist1", "dist2", "build-temp"]),
